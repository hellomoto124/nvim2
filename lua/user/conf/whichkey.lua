...
local mappings = {
  ...
  ["-"] = { "<cmd>resize -2<cr>", "resize -2" },
  ["="] = { "<cmd>resize +2<cr>", "resize +2" },
  ["["] = { "<cmd>vertical resize +2<cr>", "vertical resize +2" },
  ["]"] = { "<cmd>vertical resize -2<cr>", "vertical resize -2" },

  w ={
    name = "Windows:history-shift",
    ["b"] = { "<cmd>Telescope buffers<cr>", "switch diff buffer by telescope" },
    ["h"] = { "<cmd>LocalHistoryToggle<cr>", "hisotry revert" },
    ["s"] = { "<cmd>WinShift<cr>", "switch current window to the positon" },
    -- ["-"] = { "<cmd>resize -2<cr>", "resize -2" },
    -- ["="] = { "<cmd>resize +2<cr>", "resize +2" },
    -- ["["] = { "<cmd>vertical resize -2<cr>", "vertical resize -2" },
    -- ["]"] = { "<cmd>vertical resize +2<cr>", "vertical resize +2" },
