...
-- keymap("n", "<C-W>m", ":WinShift<cr>", opts) ,move to whichkey
...
--keymap("n", "<S-,>", ":BufferLineCyclePrev<CR>", opts)
...
--ranger
keymap('n', '<leader>rr', ':RnvimrToggle<CR>', opts)

--calendar
keymap('n', '<leader>nw', ':Calendar -view -week_number = year<CR>', opts)
keymap('n', '<leader>cc', ':Calendar -view = clock<CR>', opts)
--search
-- keymap('n', '<leader>x', ":<cmd>lua require('telescope').extensions.live_grep_raw.live_grep_raw(require('telescope.themes').get_ivy())<cr>", opts) --super search like "-g *.java keyword"
